...
release = u'{{cookiecutter.initial_version}}'
...
latex_documents = [
    (master_doc, 'Chemist.tex', '{{cookiecutter.project_name}} Documentation',
...
man_pages = [
    (master_doc, '{{cookiecutter.module_name}}', u'Flask Chemist Documentation',
     [author], 1)
]
